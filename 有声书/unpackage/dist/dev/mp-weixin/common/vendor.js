...
/***/ 11:
/*!*****************************************!*\
  !*** E:/piece/有声书/store/audio/audio.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
timeout;var _default =
{
  ...
  getters: {
    ...
    singerName: function singerName(state) {
      var curIndex = state.currentPlayIndex;
      var singer = state.musics[curIndex].singer;
      return singer.name;
    },
    // 歌手简介
    ...
    // 音频封面
    CurCover: function CurCover(state) {
      var curIndex = state.currentPlayIndex;
  ...
  mutations: {
    ...
    // 音频暂停
    audioPause: function audioPause(state) {
      var curIndex = state.currentPlayIndex;
      state.audioList[curIndex].playStatus = -1;
      audio.pause();
    },
    // 音频停止
    audioStop: function audioStop(state) {
      var curIndex = state.currentPlayIndex;
    ...
    // 获取音频资源
    getMusic: function getMusic(state, musicResourecs) {
  ...
  actions: {
    //初始化
    init: function init(_ref) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var state, commit, dispatch, _yield$http$get, musicResourecs;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:state = _ref.state, commit = _ref.commit, dispatch = _ref.dispatch;if (!
                audio) {_context.next = 3;break;}return _context.abrupt("return");case 3:_context.next = 5;return (

                  _request.default.get('/musicResourecs'));case 5:_yield$http$get = _context.sent;musicResourecs = _yield$http$get.musicResourecs;
    ...
    // 列表选择播放
    selectPlay: function selectPlay(_ref6, id) {var state = _ref6.state,commit = _ref6.commit;
      var curIndex = state.musics.findIndex(function (item) {return item.id === id;});
  ...
  request: function request() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    return new Promise(function (res, rej) {
      ...
      options), {}, {
        ...
        fail: function fail(_ref) {var errMsg = _ref.errMsg;
          uni.showToast({
            title: errMsg || '请求失败',
            icon: 'none' });
...
/***/ 34:
/*!***********************************!*\
  !*** E:/piece/有声书/common/unit.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 基本参数
...
/***/ 35:
/*!************************************************!*\
  !*** E:/piece/有声书/pages/sort/sortResources.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.sortResources = void 0;var sortResources = [{
  id: 1,
  text: "有声书",
...

{
  id: 14,
  text: "戏曲",
  content: ['戏曲大全', '华美京剧', '温婉越剧', '明快黄梅', '多彩泸剧', '典雅昆剧'] }];exports.sortResources = sortResources;

/***/ }),

/***/ 4:
/*!*******************************!*\
  !*** E:/piece/有声书/pages.json ***!
  \*******************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 7:
/*!***********************************************!*\
  !*** E:/piece/有声书/pages.json?{"type":"stat"} ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__1EA9444" };exports.default = _default;

/***/ }),

/***/ 8:
/*!************************************************!*\
  !*** E:/piece/有声书/pages.json?{"type":"style"} ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "首页" }, "pages/sort/sort": { "navigationBarTitleText": "分类" }, "pages/collection/collection": { "navigationBarTitleText": "收藏" }, "pages/mine/mine": { "navigationBarTitleText": "我的" }, "pages/readLIst/readLIst": { "navigationBarTitleText": "榜单" }, "pages/listenNoval/listenNoval": { "navigationBarTitleText": "小说" }, "pages/listenMusic/listenMusic": { "navigationBarTitleText": "音乐" }, "pages/listenKnowledge/listenKnowledge": { "navigationBarTitleText": "知识" }, "pages/musicDetail/musicDetail": { "navigationBarTitleText": "音乐详情" }, "pages/bookDetail/bookDetail": { "navigationBarTitleText": "图书详情" }, "pages/reading/reading": { "navigationBarTitleText": "阅读页" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 9:
/*!***********************************!*\
  !*** E:/piece/有声书/store/index.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _audio = _interopRequireDefault(__webpack_require__(/*! ./audio/audio.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 94:
/*!******************************************!*\
  !*** E:/piece/有声书/common/html-parser.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
